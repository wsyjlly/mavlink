...
public class RcChannelsOverride implements Message {
	...
	public void messagePayload(byte[] messagePayload) {
		...
		this.chan1Raw = byteArray.getUnsignedInt16(2);
		this.chan2Raw = byteArray.getUnsignedInt16(4);
		this.chan3Raw = byteArray.getUnsignedInt16(6);
		this.chan4Raw = byteArray.getUnsignedInt16(8);
		this.chan5Raw = byteArray.getUnsignedInt16(10);
		this.chan6Raw = byteArray.getUnsignedInt16(12);
		this.chan7Raw = byteArray.getUnsignedInt16(14);
		this.chan8Raw = byteArray.getUnsignedInt16(16);
	}
